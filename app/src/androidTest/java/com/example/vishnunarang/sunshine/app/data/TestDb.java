 ...
 */
package com.example.vishnunarang.sunshine.app.data;
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        Cursor weatherCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,
                null,  // all columns (columns to fetch)
        ...
        TestUtilities.validateCurrentRecord("Error: Validation failed for weather data", weatherCursor, weatherTestValues);
    ...
    public long insertLocation() {
        ...
        assertFalse("RowId is -1", locationRowId == -1);
